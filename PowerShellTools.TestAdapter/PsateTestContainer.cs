...
{
    public class PsateTestContainer:ITestContainer
    {
        private ITestContainerDiscoverer discoverer;
        public PsateTestContainer(ITestContainerDiscoverer discoverer, string source, Uri executorUri)
            :this(discoverer, source, executorUri, Enumerable.Empty<Guid>())
        {}

        public PsateTestContainer(ITestContainerDiscoverer discoverer, string source, Uri executorUri, IEnumerable<Guid> debugEngines)
        {
            this.Source = source;
        ...
        private PsateTestContainer(PsateTestContainer copy)
        ...
        {
            var testContainer = other as PsateTestContainer;
        ...
        {
            return new PsateTestContainer(this);
        }
    }
}
