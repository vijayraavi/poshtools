...
namespace PowerShellTools.LanguageService
{
    ...
    class DropDownBarClient : IVsDropdownBarClient
    {
        ...
        struct DropDownEntryInfo
        {
            ...
            public string Name
            {
                get
                {
                    ...
                    FunctionDefinitionAst func = Body as FunctionDefinitionAst;
                    if (func != null)
                    {
                        return func.Name;
                    }
            ...
            public int ImageListIndex
            {
                get
                {
                 ...
                 //   }
                    if ((funcDef = Body as FunctionDefinitionAst) != null)
                    {
        ...
        private static ReadOnlyCollection<DropDownEntryInfo> CalculateEntries(Ast suite)
        {
            ...
            if (suite != null)
            {
                foreach (var function in suite.FindAll(x => x is FunctionDefinitionAst, true).Cast<FunctionDefinitionAst>())
                {
                    newEntries.Add(new DropDownEntryInfo(function));
                }
            }
