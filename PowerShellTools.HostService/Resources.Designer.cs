...
namespace PowerShellTools.HostService {
    ...
    public class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Unable to attach with current local PowerShell version ({0}). Please ensure that PowerShell v4 or higher is installed..
        /// </summary>
        public static string EnumLocalVersionError {
            get {
                return ResourceManager.GetString("EnumLocalVersionError", resourceCulture);
            }
        }
